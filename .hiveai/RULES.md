...
## Truth
- Canonical task ledger: `docs/FORMULAB_V1_TASK_TRACKER.md`.
...
Event schema: `{"schema":"hiveai-event/v1","eventId":"<id>","projectKey":"formulab","type":"<type>","at":"<UTC>","actor":"CODEX|CLAUDE|CHATGPT|OWNER|SYSTEM","taskId":"<id|null>","workflowState":"<state>","summary":"<fact>","commit":"<sha|null>","auditId":"<id|null>","sessionId":"<id|null>"}`
