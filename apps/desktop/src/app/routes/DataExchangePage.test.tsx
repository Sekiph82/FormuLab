...
describe("DataExchangePage — Template Library", () => {
  it("shows all 44 template cards by default", async () => {
    renderPage();
    ...
    // 44 upload buttons, one per card — the most reliable proxy for card count.
    expect(screen.getAllByRole("button", { name: "Upload" })).toHaveLength(44);
  });
