 ...
 *  `mimeType` always comes from `@formulab/shared`'s `DOCUMENT_FORMAT_MIME_TYPES`,
 *  never a locally re-declared value. */
import { DOCUMENT_FORMAT_MIME_TYPES, type DocumentFormat, type DossierExportSnapshot } from "@formulab/shared";
