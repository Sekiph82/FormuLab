...
export const SEED_TEST_DEFINITIONS: TestDefinition[] = [
  ...
  def("TEST-PACKAGING-COMPATIBILITY", "Packaging compatibility", "packaging", { resultType: "pass_fail", passFailLogic: { rule: "manual_judgment" } }),
  ...
  def("TEST-SEAL-INTEGRITY", "Seal integrity", "packaging", { resultType: "pass_fail", passFailLogic: { rule: "manual_judgment" }, criticalTestFlag: true }),
  def("TEST-LEAK", "Leak test", "packaging", { resultType: "pass_fail", passFailLogic: { rule: "manual_judgment" }, criticalTestFlag: true }),
