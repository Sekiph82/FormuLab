...
| FVL-03 | [#4](https://github.com/Sekiph82/FormuLab/issues/4) | 18 | 16 | 0 | 2 |
...
| **Total** | milestone [#1](https://github.com/Sekiph82/FormuLab/milestone/1) | **171** | **61** | **0** | **110** |

Overall: **61 / 171 tasks completed (35.7%)**. FVL-01 and FVL-02 are the
only fully closed packages (100%, 21/21 and 24/24). FVL-03 is 16/18
(88.9%) after FVL-03.001-.010 (Material Master through Regulatory Engine
integration). FVL-04 grew from 12 to 26 tasks on 2026-08-18 —
