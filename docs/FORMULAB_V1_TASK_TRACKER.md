...
| FVL-03 | [#4](https://github.com/Sekiph82/FormuLab/issues/4) | 18 | 15 | 0 | 3 |
...
| **Total** | milestone [#1](https://github.com/Sekiph82/FormuLab/milestone/1) | **171** | **60** | **0** | **111** |

Overall: **60 / 171 tasks completed (35.1%)**. FVL-01 and FVL-02 are the
only fully closed packages (100%, 21/21 and 24/24). FVL-03 is 15/18
(83.3%) after FVL-03.001-.009 (Material Master through Safety Engine
