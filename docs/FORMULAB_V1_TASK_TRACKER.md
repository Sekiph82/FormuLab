...
| FVL-03 | [#4](https://github.com/Sekiph82/FormuLab/issues/4) | 18 | 17 | 0 | 1 |
...
| **Total** | milestone [#1](https://github.com/Sekiph82/FormuLab/milestone/1) | **171** | **62** | **0** | **109** |

Overall: **62 / 171 tasks completed (36.3%)**. FVL-01 and FVL-02 are the
only fully closed packages (100%, 21/21 and 24/24). FVL-03 is 17/18
(94.4%) after FVL-03.001-.011 (Material Master through end-to-end
provenance integration). FVL-04 grew from 12 to 26 tasks on 2026-08-18 —
